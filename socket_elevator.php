...
//if( ($socket = socket_create(AF_INET, SOCK_STREAM, SOL_TCP)) and (socket_connect($socket, $from_ip, 5005)) ) {
//	read_transaction(1055, 1, $socket, $mysqli);
//	socket_close($socket);
//}
...
//	0000
//	0000
//	202020202020202020202020202020	//Документ-основание
//	0200
