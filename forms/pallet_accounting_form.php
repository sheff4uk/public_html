			...
			<table style="width: 100%; table-layout: fixed;">
				<thead>
					<tr>
						...
						<th class="wrong">Из них другого формата</th>
				...
				<tbody style="text-align: center;">
					<tr>
						...
						<td class="wrong"><input type="number" name="wrong" min="0" style="width: 70px;"></td>
	...
	$(function() {
		...
		$('.add_incoming').click( function() {
			...
			if( incoming_ID ) {
				...
				$('#pallet_incoming_form input[name="wrong"]').val(incoming_data['wrong']);
		...
		$('#pallet_incoming_form select[name="source"]').change(function() {
			...
			if( cls == 'rtrn' ) {
				...
				$('#pallet_incoming_form .wrong').show('fast');
				$('#pallet_incoming_form input[name="wrong"]').prop('required', true);
				...
				$('#pallet_incoming_form .broken').show('fast');
				$('#pallet_incoming_form input[name="broken"]').prop('required', true);
				$('#pallet_incoming_form .wrong').hide('fast');
				$('#pallet_incoming_form input[name="wrong"]').prop('required', false);
