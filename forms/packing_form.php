...
if( isset($_POST["LF_ID"]) ) {
	...
	if( $add ) {
		exit ('<meta http-equiv="refresh" content="0; url=/packing.php?p_date='.$p_date.'&p_post='.$p_post.'&add#'.$LP_ID.'">');
	}
	else {
		exit ('<meta http-equiv="refresh" content="0; url=/packing.php#'.$LP_ID.'">');
	}
}
?>
